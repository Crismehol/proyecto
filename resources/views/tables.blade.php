...
<html class='no-js' lang='en'>
  <head>
    ...
    <link href="{{ URL::asset('application-a07755f5.css') }}" rel="stylesheet" type="text/css" /><link href="//netdna.bootstrapcdn.com/font-awesome/3.2.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
      ...
      <section id='sidebar'>
        ...
        <ul id='dock'>
          <li class='launcher'>
            ...
            <a href="template.blade.php">Dashboard</a>
          </li>
          <li class='launcher'>
            <i class='icon-file-text-alt'></i>
            <a href="forms.blade.php">Forms</a>
          </li>
          <li class='active launcher'>
            <i class='icon-table'></i>
            <a href="tables.blade.php">Tables</a>
          </li>
